...
public class AverageRadioOptions extends RadioOptions {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            if (mIsPortrait) {
                getChildAt(i).layout((int) (mChildWidth * i + mMarginLeft),
                        (int) mMarginTop, (int) (mChildWidth * (i + 1) - mMarginRight), (int) (mChildHeight - mMarginBottom));
            } else {
                getChildAt(i).layout((int) mMarginLeft,
                        (int) (mChildHeight * i + mMarginTop), (int) (mChildWidth - mMarginRight), (int) (mChildHeight * (i + 1) - mMarginBottom));
            }
        }
    }
